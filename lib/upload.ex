defmodule GameriaStorage.Upload do
  ...
  defmacro __using__(opts) do
    ...
    acceptable_types =
      Keyword.get(opts, :acceptable_file_types) || raise "should set acceptable_file_types"
    ...
    {:__block__, metadata_list,
     ast ++
       func_file_name_ast ++ func_upload_path_ast ++ func_move_file_ast ++ func_size_limit_ast}
  end

  defmacro __before_compile__(env) do
    {:__block__, metadata, ast} =
      quote do
